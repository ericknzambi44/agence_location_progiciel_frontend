 ...
 * Les dates sont saisies via un champ type="date" (format YYYY-MM-DD).
 */
...
import { Loader2, Calculator, AlertCircle, FileText, User, Package, Calendar } from 'lucide-react';
import { EstimationDetail } from '../views/EstimationDetail'; 
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Format: AAAA-MM-JJ (ex: 2026-01-01)</p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Format: AAAA-MM-JJ (ex: 2026-01-10)</p>
              </div>
            </div>
